...
/**
*/
export class UartGeneratorApp {

    static __wrap(ptr) {
        const obj = Object.create(UartGeneratorApp.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_uartgeneratorapp_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.uartgeneratorapp_new();
        return UartGeneratorApp.__wrap(ret);
    }
    /**
    */
    on_submit() {
        wasm.uartgeneratorapp_on_submit(this.ptr);
    }
    /**
    * @returns {string}
    */
    get_result() {
        try {
            ...
            wasm.uartgeneratorapp_get_result(retptr, this.ptr);
...
async function init(input) {
    ...
    imports.wbg.__wbg_instanceof_HtmlDivElement_a48577162b6fbe4b = function(arg0) {
    ...
    imports.wbg.__wbg_selectedIndex_e28ecedea2a2ee56 = function(arg0) {
    ...
    imports.wbg.__wbg_text_90f2d9a1e6c1ce04 = function(arg0, arg1) {
